 ...
 * @param value Pointer to the string to duplicate. Must be zero-terminated if   length is "unknown".
 * @param length Length of the value. if equals to unknown, then it will be  computed using strlen(value).
...
Value Value::get(char const* key, char const* end,
